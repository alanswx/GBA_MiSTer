...
parameter        CDnCr = 1'b0;
   ...
   begin: Prefetch
      ...
      begin
         PrefetchedInstruction <= 32'h00000000;
   ...
   begin: ImmediateDataRegs
      if (nRESET == 1'b0)		// Reset
      begin
         SExtOffset24Bit <= 32'h00000000;
         Offset12Bit <= 32'h00000000;
         Offset8Bit <= 32'h00000000;
         Immediate8Bit <= 32'h00000000;
      end
      else 		// Clock
      begin
         if (StagnatePipeline == 1'b0 & CLKEN == 1'b1)		// Clock enable
         begin
            SExtOffset24Bit <= { {8{FromThumbDecoder[23]}}, FromThumbDecoder[23:0]};
            Offset12Bit <= {20'h00000, FromThumbDecoder[11:0]};
            Offset8Bit <= {24'h000000, FromThumbDecoder[11:8], FromThumbDecoder[3:0]};
            Immediate8Bit <= {24'h000000, FromThumbDecoder[7:0]};
         end
      end
   end
   ...
   assign ByteExtended = (SignExt == 1'b0) ? {24'h000000, DataReg[7:0]} : 
                         { {24{DataReg[7]}}, DataReg[7:0]};
   
   assign HalfWordExtended = (SignExt == 1'b0) ? {16'h0000, DataReg[15:0]} : 
                             { {16{DataReg[15]}}, DataReg[15:0]};
